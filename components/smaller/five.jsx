...
export default function Five(){
	return (
		<a href="https://github.com/yashnirmal" target="_blank" className="bg-white cont md:min-h-[400px] lg:min-w-[200px] bg-gradient-to-br p-4 from-gray-600 to-gray-800 flex flex-col text-white cont">
